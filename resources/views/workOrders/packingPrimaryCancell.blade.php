...
<div class="modal-content"  style="width:150%;">
 ...
 <br>BOX TYPE: 
 <input readonly class='form-control'  value="PRIMARY"><BR>
 <br>BOX SL NO: 
 ...
 confirm Cancell this package 
          ...
          <button type="submit" class="btn btn-danger" onclick="deletePrimaryPackage();">CANCEL PACKAGE</button>
  ...
  function deletePrimaryPackage()
  {
    ...
    data = 'WORK_ORDER_ID='+WORK_ORDER_ID + '&CUSTOMER_PART_NO='+CUSTOMER_PART_NO +
      '&SL_NO='+SL_NO+'&PRIMARY_BARCODE='+PRIMARY_BARCODE ;
       ...
       var completeurl = url +'/delete_Package_primary' ;
       var type = "POST";
