       ...
       for($pageno=1;$pageno<=$copyPrint;$pageno++){ 
        ...
        <table class='pad' border=1>
            ...
            <tr style="line-height:10px;">
                <td  colspan='2' style='width:385px; line-height:10px;' rowspan=2 >
                    ...
                    <table border=0  class='hiddenTable'  ><tr><td style="padding-left:5px; padding-right:5px; padding-bottom: 5px;"><font size='-3'>QUANTITY (Q)</font></td><td>
            ...
            <tr>      
                ...
                <font size='-3'>SUPPLIER (V)</font>
                </td><td  style="font-size: 24px;">{{$SUPPLIER}}</td></tr>
                <?PHP $SUPPLIER1='V'.$SUPPLIER; ?>
                <tr><td colspan=2 style=' padding-left: 4px; padding-bottom: 5px;'><div>{!! DNS1D::getBarcodeHTML("$SUPPLIER1", 'C39',1.2,42) !!}</div></td>
                </tr></table>    
               </td>
                <td colspan=4>
            ...
            <tr>
                ...
                <td colspan='3' style='width:420px; padding-bottom: 0px;'>
                    
                <table  border='0' class='hiddenTable'   ><tr>
                <?PHP $BILLING_DOCUMENT1=$BILLING_DOCUMENT; ?>
                <tr><td colspan=2 style=' padding-left: 5px;  padding-top: 5px;'><div>{!! DNS1D::getBarcodeHTML("$BILLING_DOCUMENT1", 'C39',1.2,42) !!}</div></td>
                </tr><tr><td>
                <font size='-3'>INVOICE NO.</font>
                </td><td   style="font-size: 24px; padding-left: 5px;  padding-top: 1px; padding-bottom: 1px;">{{$BILLING_DOCUMENT}}</td>
                </tr></table>
        ...
        <table   border='0' class='hiddenTable'  >
               <tr><td style='padding-left:0px;'>
                ...
                <tr><td colspan=2 style='padding-left:5px; padding-right:5px; padding-bottom: 5px;'><div>{!! DNS1D::getBarcodeHTML("$REV_LEVEL1", 'C39',1.2,42) !!}</div></td>
                </tr>
                </table>
