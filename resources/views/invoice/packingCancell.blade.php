...
<div class="modal-content"  style="width:150%;">
 ...
 confirm Cancell this package 
          ...
          <button type="submit" class="btn btn-danger" onclick="deletePackage();">CANCEL PACKAGE</button>
...
<script>
  ...
  function deletePackage()
  {
    ...
    data = 'INVOICE_ID='+INVOICE_ID + '&CUSTOMER_PART_NO='+CUSTOMER_PART_NO +
      '&SL_NO='+SL_NO+'&PRIMARY_BARCODE='+PRIMARY_BARCODE ;
       

       var completeurl = url +'/delete_Package' ;
       var type = "POST";
